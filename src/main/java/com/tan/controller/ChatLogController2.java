...
@ServerEndpoint("/chatlog2/{sender}/{recevied}")
public class ChatLogController2 {
...
private static CopyOnWriteArraySet<ChatLogController2> webSocketSet = new CopyOnWriteArraySet<ChatLogController2>();
...
public void onOpen(@PathParam(value="sender") String sender,@PathParam(value="recevied") String recevied,Session session){
   ...
   // System.out.println("有新连接加入！当前在线人数为" + getOnlineCount());
    ...
    try {
		session.getBasicRemote().sendText("ni hao a");
