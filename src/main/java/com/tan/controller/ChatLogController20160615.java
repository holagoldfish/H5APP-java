...
@ServerEndpoint(value="/chatlogok/{sender}/{recevied}")
public class ChatLogController20160615 {
	
private ChatLogDao chatLogDao=new ChatLogDao();

//与某个客户端的连接会话，需要通过它来给客户端发送数据
private Session session;
private static CopyOnWriteArraySet<ChatLogController20160615> webSocketSet = new CopyOnWriteArraySet<ChatLogController20160615>();
