...
@ServerEndpoint(value="/chatlog4/{sender}/{recevied}")
public class ChatLogController20160616ok {
...
private static CopyOnWriteArraySet<ChatLogController20160616ok> webSocketSet = new CopyOnWriteArraySet<ChatLogController20160616ok>();
